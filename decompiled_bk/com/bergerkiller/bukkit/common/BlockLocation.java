...
public class BlockLocation {
    ...
    public BlockLocation(ConfigurationNode node) {
        ...
        this.x = node.get("x", Integer.valueOf(0));
        this.y = node.get("y", Integer.valueOf(0));
        this.z = node.get("z", Integer.valueOf(0));
    }
    ...
    public BlockLocation(String world, IntVector3 coordinates) {
        this.world = world;
    ...
    public Location getLocation() {
        World world = this.getWorld();
        return world == null ? null : new Location(world, (double)this.x + 0.5, (double)this.y + 0.5, (double)this.z + 0.5);
    }
    ...
    public boolean isIn(BlockLocation point1, BlockLocation point2) {
        if (point1 != null && point2 != null && point1.world.equals(point2.world) && point1.world.equals(this.world)) {
            int value = Math.min(point1.x, point2.x);
    ...
    public void save(ConfigurationNode node) {
        node.set("world", (Object)this.world);
        node.set("x", (Object)this.x);
        node.set("y", (Object)this.y);
        node.set("z", (Object)this.z);
    }
}
