...
class PlayerFileDataHandler_1_8_to_1_15_2
extends PlayerFileDataHandler {
    ...
    public PlayerFileDataHandler_1_8_to_1_15_2() {
        ...
        this.playerListFileDataField = (FastField)LogicUtil.unsafeCast(SafeField.create(PlayerListHandle.T.getType(), "playerFileData", playerFileDataType).getFastField());
    }
    ...
    implements PlayerFileDataHandler.Hook {
        ...
        public Object load(Object entityHuman) {
            ...
            return this.base_load_raw(entityHuman).orElse(null);
        }
