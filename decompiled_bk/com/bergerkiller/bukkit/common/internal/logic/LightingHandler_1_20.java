...
implements LightingHandler {
    ...
    public LightingHandler_1_20() throws Throwable {
        ...
        String light_layer_block_name = "blockEngine";
        String light_layer_sky_name = "skyEngine";
        String light_storage_name = "storage";
        String light_storage_array_live_name = "updatingSectionData";
        ...
        this.light_storage = MPLType.getDeclaredField(lightEngineType, Resolver.resolveFieldName(lightEngineType, light_storage_name));
        if (!lightEngineStorageType.isAssignableFrom(this.light_storage.getType())) {
            throw new IllegalStateException("LightEngine light_storage field is not of type LayerLightSectionStorage");
        }
        ...
        Field f = Resolver.resolveAndGetDeclaredField(Class.forName("net.minecraft.server.level.ChunkLevel"), "MAX_LEVEL");
        ...
        for (Object constant : updateType.getEnumConstants()) {
            ...
            if (!name.equals("POST_UPDATE")) continue;
            postUpdate = constant;
        }
        if (preUpdate == null) {
        ...
        this.light_engine_schedule = Resolver.resolveAndGetDeclaredMethod(CommonUtil.getClass("net.minecraft.server.level.ThreadedLevelLightEngine"), "addTask", Integer.TYPE, Integer.TYPE, IntSupplier.class, updateType, Runnable.class);
    ...
    public CompletableFuture<Void> setSectionBlockLightAsync(World world, int cx, int cy, int cz, byte[] data) {
        return this.scheduleUpdate(world, new UpdateTask(cx, cy, cz, data){
            ...
            public void run(LightEngineData data) {
                ...
                LightingHandler_1_20.this.handle.storeBlockLightData(data.lightEngine, this.cx, this.cy, this.cz, this.data);
            }
        });
    }
    ...
    public CompletableFuture<Void> setSectionSkyLightAsync(World world, int cx, int cy, int cz, byte[] data) {
        return this.scheduleUpdate(world, new UpdateTask(cx, cy, cz, data){
            ...
            public void run(LightEngineData data) {
                ...
                LightingHandler_1_20.this.handle.storeSkyLightData(data.lightEngine, this.cx, this.cy, this.cz, this.data);
            }
        });
    }
    ...
    extends Template.Class<Template.Handle> {
        @Template.Generated(value="public static byte[] getLayerData(LightEngine engine, int cx, int cy, int cz) {\n   if (engine == null) {\n       return null;\n   }\n              DataLayer array = engine.getDataLayerData(SectionPos.of(cx, cy, cz));\n   if (array == null) {\n       return null;\n   }\n              return array.getData();\n}")
        public abstract byte[] getLightData(Object var1, int var2, int var3, int var4);

        @Template.Generated(value="public static void storeSkyLightData(LevelLightEngine engine, int cx, int cy, int cz, byte[] data_bytes) {\n    final SectionPos pos = SectionPos.of(cx, cy, cz);\n    engine.queueSectionData(LightLayer.SKY, pos, new DataLayer(data_bytes));\n}")
        public abstract void storeSkyLightData(Object var1, int var2, int var3, int var4, byte[] var5);

        @Template.Generated(value="public static void storeBlockLightData(LevelLightEngine engine, int cx, int cy, int cz, byte[] data_bytes) {\n    final SectionPos pos = SectionPos.of(cx, cy, cz);\n    engine.queueSectionData(LightLayer.BLOCK, pos, new DataLayer(data_bytes));\n}")
    ...
    private final class EngineUpdateTaskLists {
         ...
         */
        public void preRun() {
            Map map = LightingHandler_1_20.this.task_lists;
            synchronized (map) {
        ...
        private void schedule() throws IllegalStateException {
            try {
                IntSupplier priority = LightingHandler_1_20.this.golden_ticket;
                LightingHandler_1_20.this.light_engine_schedule.invoke(this.engine.getRaw(), 0, 0, priority, LightingHandler_1_20.this.light_engine_pre_update, this::preRun);
                LightingHandler_1_20.this.light_engine_schedule.invoke(this.engine.getRaw(), 0, 0, priority, LightingHandler_1_20.this.light_engine_post_update, this::postRun);
            }
            catch (Throwable t) {
    ...
    private final class LightEngineData {
        ...
        public LightEngineData(Object lightEngine) {
            ...
            Object array = null;
            try {
                layer = LightingHandler_1_20.this.light_layer_block.get(lightEngine);
                if (layer != null) {
                    storage = LightingHandler_1_20.this.light_storage.get(layer);
                    array = LightingHandler_1_20.this.light_storage_array_live.get(storage);
                }
            }
            catch (Throwable t) {
            ...
            array = null;
            try {
                layer = LightingHandler_1_20.this.light_layer_sky.get(lightEngine);
                if (layer != null) {
                    storage = LightingHandler_1_20.this.light_storage.get(layer);
                    array = LightingHandler_1_20.this.light_storage_array_live.get(storage);
                }
