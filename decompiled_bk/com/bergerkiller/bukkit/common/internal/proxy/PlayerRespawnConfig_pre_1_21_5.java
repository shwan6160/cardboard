...
public final class PlayerRespawnConfig_pre_1_21_5 {
    ...
    public boolean equals(Object o) {
        if (o instanceof PlayerRespawnConfig_pre_1_21_5) {
            ...
            return LogicUtil.bothNullOrEqual(this.dimension, other.dimension) && LogicUtil.bothNullOrEqual(this.position, other.position) && this.angle == other.angle && this.forced == other.forced;
        }
        return false;
    }
}
