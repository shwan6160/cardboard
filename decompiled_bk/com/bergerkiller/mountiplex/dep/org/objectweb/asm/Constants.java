...
final class Constants {
    ...
    static boolean isWhitelisted(String internalName) {
        if (!internalName.startsWith("com/bergerkiller/mountiplex/dep/org/objectweb/asm/")) {
            return false;
        }
    ...
    private static /* synthetic */ String stringConcat$1(String string) {
        return "com/bergerkiller/mountiplex/dep/org/objectweb/asm/util/Trace" + string + "Visitor(\\$.*)?";
    }

    private static /* synthetic */ String stringConcat$2(String string) {
        return "com/bergerkiller/mountiplex/dep/org/objectweb/asm/util/Check" + string + "Adapter(\\$.*)?";
    }
