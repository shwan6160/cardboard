...
import com.bergerkiller.mountiplex.dep.javassist.bytecode.DuplicateMemberException;
import com.bergerkiller.mountiplex.dep.javassist.bytecode.ExceptionsAttribute;
import com.bergerkiller.mountiplex.dep.javassist.bytecode.FieldInfo;
...
import com.bergerkiller.mountiplex.dep.javassist.util.proxy.FactoryHelper;
import com.bergerkiller.mountiplex.dep.javassist.util.proxy.MethodFilter;
...
import com.bergerkiller.mountiplex.dep.javassist.util.proxy.ProxyObject;
import com.bergerkiller.mountiplex.dep.javassist.util.proxy.RuntimeSupport;
import com.bergerkiller.mountiplex.dep.javassist.util.proxy.SecurityActions;
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "com.bergerkiller.mountiplex.dep.javassist.util.proxy.RuntimeSupport";
    ...
    private static final String packageForJavaBase = "com.bergerkiller.mountiplex.dep.javassist.util.proxy.";
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic(NULL_INTERCEPTOR_HOLDER, "makeSerializedProxy", "(Ljava/lang/Object;)Lcom/bergerkiller/mountiplex/dep/javassist/util/proxy/SerializedProxy;");
        code.addOpcode(176);
        minfo.setCodeAttribute(code.toCodeAttribute());
        return minfo;
    }
