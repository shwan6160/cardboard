...
import com.bergerkiller.mountiplex.dep.javassist.tools.reflect.CompiledClass;
    ...
    private static void processClasses(CompiledClass[] entries, int n) throws Exception {
        ...
        for (i = 0; i < n; ++i) {
            ...
            if (entries[i].metaobject != null || entries[i].classobject != null) {
                String metaobj = entries[i].metaobject == null ? "com.bergerkiller.mountiplex.dep.javassist.tools.reflect.Metaobject" : entries[i].metaobject;
                String classobj = entries[i].classobject == null ? "com.bergerkiller.mountiplex.dep.javassist.tools.reflect.ClassMetaobject" : entries[i].classobject;
