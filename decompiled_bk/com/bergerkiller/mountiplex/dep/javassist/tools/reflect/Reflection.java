...
import com.bergerkiller.mountiplex.dep.javassist.Translator;
...
import com.bergerkiller.mountiplex.dep.javassist.tools.reflect.CannotReflectException;
...
implements Translator {
    ...
    static final String metaobjectClassName = "com.bergerkiller.mountiplex.dep.javassist.tools.reflect.Metaobject";
    static final String classMetaobjectClassName = "com.bergerkiller.mountiplex.dep.javassist.tools.reflect.ClassMetaobject";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        this.classPool = pool;
        String msg = "com.bergerkiller.mountiplex.dep.javassist.tools.reflect.Sample is not found or broken.";
        try {
            CtClass c = this.classPool.get("com.bergerkiller.mountiplex.dep.javassist.tools.reflect.Sample");
            ...
            throw new RuntimeException("com.bergerkiller.mountiplex.dep.javassist.tools.reflect.Sample is not found or broken.");
        }
        catch (BadBytecode e) {
            throw new RuntimeException("com.bergerkiller.mountiplex.dep.javassist.tools.reflect.Sample is not found or broken.");
        }
    ...
    private boolean modifyClassfile(CtClass clazz, CtClass metaobject, CtClass metaclass) throws CannotCompileException, NotFoundException {
        ...
        CtClass mlevel = this.classPool.get("com.bergerkiller.mountiplex.dep.javassist.tools.reflect.Metalevel");
