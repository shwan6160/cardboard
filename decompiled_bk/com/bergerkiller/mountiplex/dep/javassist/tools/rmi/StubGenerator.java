...
import com.bergerkiller.mountiplex.dep.javassist.CtNewConstructor;
...
implements Translator {
    ...
    private static final String sampleClass = "com.bergerkiller.mountiplex.dep.javassist.tools.rmi.Sample";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        ...
        this.proxyConstructorParamTypes = pool.get(new String[]{"com.bergerkiller.mountiplex.dep.javassist.tools.rmi.ObjectImporter", "int"});
        this.interfacesForProxy = pool.get(new String[]{"java.io.Serializable", "com.bergerkiller.mountiplex.dep.javassist.tools.rmi.Proxy"});
        this.exceptionForProxy = new CtClass[]{pool.get("com.bergerkiller.mountiplex.dep.javassist.tools.rmi.RemoteException")};
    }
    ...
    private CtClass produceProxyClass(CtClass orgclass, Class<?> orgRtClass) throws CannotCompileException, NotFoundException {
        ...
        CtField f = new CtField(this.classPool.get("com.bergerkiller.mountiplex.dep.javassist.tools.rmi.ObjectImporter"), fieldImporter, proxy);
        f.setModifiers(2);
