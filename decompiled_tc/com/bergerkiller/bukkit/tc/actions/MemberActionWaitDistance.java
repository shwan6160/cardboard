...
public class MemberActionWaitDistance
...
implements WaitAction {
    ...
    implements ActionRegistry.Serializer<MemberActionWaitDistance> {
        @Override
        public boolean save(MemberActionWaitDistance action, OfflineDataBlock data, ActionTracker tracker) throws IOException {
            data.addChild("wait-distance", stream -> stream.writeDouble(action.getDistance()));
            return true;
        }
