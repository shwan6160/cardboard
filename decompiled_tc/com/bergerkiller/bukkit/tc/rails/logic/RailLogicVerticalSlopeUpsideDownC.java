...
public class RailLogicVerticalSlopeUpsideDownC
extends RailLogicVerticalSlopeBase {
    ...
    static {
        for (int i = 0; i < 4; ++i) {
            RailLogicVerticalSlopeUpsideDownC.values[i] = new RailLogicVerticalSlopeUpsideDownC(FaceUtil.notchToFace((int)(i << 1)));
        }
    }
}
