...
public class SignActionDestroy
extends TrainCartsSignAction {
    ...
    public boolean build(SignChangeActionEvent event) {
        SignBuildOptions opt = SignBuildOptions.create().setPermission(Permission.BUILD_DESTRUCTOR).setName(event.isCartSign() ? "cart destructor" : "train destructor").setTraincartsWIKIHelp("TrainCarts/Signs/Destroyer");
