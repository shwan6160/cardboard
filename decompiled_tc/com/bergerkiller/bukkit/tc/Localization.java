 ...
 *  com.bergerkiller.bukkit.common.dep.cloud.caption.Caption
...
extends LocalizationEnum {
    ...
    public static final Localization COMMAND_IMPORT_MISSING_MODELS = new Localization("command.import.models.missing", ChatColor.YELLOW + "The imported train configuration includes model configurations [" + ChatColor.WHITE + "%0%" + ChatColor.YELLOW + "], import them by specifying --import-models");
    ...
    public static final Localization COMMAND_TICKET_NOTEDITING = new Localization("command.ticket.notediting", ChatColor.RED + "You are not editing any tickets right now\n" + ChatColor.RED + "To create a new train ticket, use /train ticket create\n" + ChatColor.RED + "To edit an existing train ticket, use /train ticket edit [name]");
    ...
    public static final Localization TICKET_MAP_USES = new Localization("ticket.map.uses", "%1%/%0% uses"){
        ...
        public void writeDefaults(ConfigurationNode config, String path) {
            ...
            node.set("1", (Object)"Single use");
            node.set("-1", (Object)"Unlimited uses");
            node.set("default", (Object)"%1%/%0% uses");
        }
    };
    ...
    public static final Localization COMMAND_ANIMATE_SUCCESS = new Localization("command.animate.success", ChatColor.GREEN + "Now playing animation " + ChatColor.YELLOW + "%0%" + ChatColor.GREEN + " at speed " + ChatColor.YELLOW + "%1%" + ChatColor.GREEN + " with phase delay " + ChatColor.YELLOW + "%2%");
    ...
    public Caption getCaption() {
        return Caption.of((String)this.getName());
    }
    ...
    public void broadcast(MinecartGroup group, String ... arguments) {
        ...
        for (Player player : receivers) {
            this.message((CommandSender)player, arguments);
        }
    }
    ...
    public void message(TrainCartsPlayer player, String ... arguments) {
        ...
        if (onlinePlayer != null) {
            this.message((CommandSender)onlinePlayer, arguments);
        }
    }
