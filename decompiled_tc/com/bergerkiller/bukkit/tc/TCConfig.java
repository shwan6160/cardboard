 ...
 *  com.bergerkiller.bukkit.common.Hastebin
 *  com.bergerkiller.bukkit.common.StringReplaceBundle
...
public class TCConfig {
    ...
    public static boolean enableCeilingBlockCollision;
    public static int collisionReEnterDelay;
    public static boolean optimizeBlockActivation;
    public static boolean activatorEjectEnabled;
    public static boolean railTrackerDebugEnabled;
    public static boolean wheelTrackerDebugEnabled;
    public static boolean animationsUseTickTime;
    public static boolean claimNewSavedTrains;
    public static boolean claimNewSavedModels;
    public static boolean onlyPoweredSwitchersDoPathFinding;
    public static boolean onlyEmptySwitchersDoPathFinding;
    public static boolean onlyRegisteredSignsHandleRedstone;
    public static boolean enableSneakingInAttachmentEditor;
    public static boolean playHissWhenStopAtStation;
    public static boolean playHissWhenDestroyedBySign;
    public static boolean playHissWhenLinked;
    public static boolean playHissWhenCartRemoved;
    public static boolean rerouteOnStartup;
    public static boolean switcherResetCountersOnFirstCart;
    public static boolean logMutexConflicts;
    public static boolean logSyncChunkLoads;
    public static boolean logTrainSplitting;
    public static String launchFunctionType;
    public static boolean parseOldSigns;
    public static boolean allowParenthesesFormat;
    public static boolean upsideDownSupportedByAll;
    public static boolean trainsCheckSignFacing;
    public static double unloadRunawayTrainDistance;
    public static int autoSaveInterval;
    public static int attachmentTransformParallelism;
    public static boolean allowExternalTicketImagePaths;
    public static boolean allowSchematicAttachment;
    public static int maxCommandSelectorValues;
    public static int maxConcurrentEffectLoops;
    public static double spawnSignCooldown;
    public static double itemPickupRadius;
    public static int maxCartsPerWorld;
    public static int maxCartsPerTrain;
    public static boolean maxCartsPerWorldCountUnloaded;
    public static boolean modelSearchCompactFolders;
    public static String currencyFormat;
    public static Set<Material> allowedBlockBreakTypes;
    public static ConfiguredWorldSet enabledWorlds;
    public static ConfiguredWorldSet disabledWorlds;
    public static boolean enableVanillaActionSigns;
    public static Map<String, ItemParser[]> parsers;
    ...
    public static void load(TrainCarts traincarts, FileConfiguration config) {
        ...
        resourcePack = new MapResourcePack((String)config.get("resourcePack", (Object)"server"));
        resourcePack.load();
        ...
        modelSearchCompactFolders = (Boolean)config.get("modelSearchCompactFolders", (Object)true);
        if (config.contains("normal")) {
            if (!config.contains("normal.cartDistanceGap") && config.contains("normal.cartDistance")) {
                config.set("normal.cartDistanceGap", (Object)((Double)config.get("normal.cartDistance", (Object)1.5) - 1.0));
            }
        ...
        cartDistanceGap = (Double)config.get("linkProperties.cartDistanceGap", (Object)0.5);
        cartDistanceGapMax = (Double)config.get("linkProperties.cartDistanceGapMax", (Object)(cartDistanceGap + 2.0));
        cartDistanceForcer = (Double)config.get("linkProperties.cartDistanceForcer", (Object)0.1);
        cartDistanceForcerConstant = (Double)config.get("linkProperties.cartDistanceForcerConstant", (Object)0.0);
        ...
        slowDownMultiplierNormal = (Double)config.get("slowDownMultiplier.normal", (Object)0.997);
        slowDownMultiplierSlow = (Double)config.get("slowDownMultiplier.slow", (Object)0.96);
        config.setHeader("maxEnterDistance", "\nThe maximum allowed enter radius for enter signs");
        maxEnterDistance = (Double)config.get("maxEnterDistance", (Object)50.0);
        config.setHeader("maxEjectDistance", "\nThe maximum allowed ejection distance for eject signs");
        maxEjectDistance = (Double)config.get("maxEjectDistance", (Object)10.0);
        config.setHeader("maxTrainEditdistance", "\nMaximum distance from which /train edit can select trains");
        maxTrainEditdistance = (Double)config.get("maxTrainEditdistance", (Object)64.0);
        config.setHeader("launchForce", "\nThe amount of velocity stations give when launching trains");
        launchForce = (Double)config.get("launchForce", (Object)10.0);
        ...
        allowPlayerCollisionFromBehind = (Boolean)config.get("allowPlayerCollisionFromBehind", (Object)false);
        config.setHeader("destroyAllOnShutdown", "\nDestroys all existing minecarts on startup and shutdown of the plugin");
        destroyAllOnShutdown = (Boolean)config.get("destroyAllOnShutdown", (Object)false);
        if (config.contains("pushAway")) {
            config.set("collision.ignoreOwners", config.get("pushAway.ignoreOwners", (Object)true));
            config.set("collision.ignoreGlobalOwners", config.get("pushAway.ignoreGlobalOwners", (Object)false));
            config.set("collision.pushAwayForce", config.get("pushAway.force", (Object)0.2));
        ...
        collisionIgnoreOwners = (Boolean)config.get("collision.ignoreOwners", (Object)false);
        collisionIgnoreGlobalOwners = (Boolean)config.get("collision.ignoreGlobalOwners", (Object)false);
        pushAwayForce = (Double)config.get("collision.pushAwayForce", (Object)0.2);
        ...
        allMinecartsAreTrainCarts = (Boolean)config.get("allMinecartsAreTrainCarts", (Object)false);
        ...
        useCoalFromStorageCart = (Boolean)config.get("useCoalFromStorageCart", (Object)false);
        config.setHeader("setOwnerOnPlacement", "\nWhether or not the player that places a minecart is set owner");
        setOwnerOnPlacement = (Boolean)config.get("setOwnerOnPlacement", (Object)true);
        ...
        launchFunctionType = (String)config.get("launchFunction", (Object)"bezier");
        ...
        keepChunksLoadedOnlyWhenMoving = (Boolean)config.get("keepChunksLoadedOnlyWhenMoving", (Object)false);
        ...
        maxKeepChunksLoadedRadius = (Integer)config.get("maxKeepChunksLoadedRadius", (Object)7);
        ...
        enableCeilingBlockCollision = (Boolean)config.get("enableCeilingBlockCollision", (Object)true);
        ...
        animationsUseTickTime = (Boolean)config.get("animationsUseTickTime", (Object)false);
        ...
        enableSneakingInAttachmentEditor = (Boolean)config.get("enableSneakingInAttachmentEditor", (Object)(!CommonCapabilities.PLAYER_OFF_HAND ? 1 : 0));
        ...
        autoSaveInterval = (Integer)config.get("autoSaveInterval", (Object)600);
        ...
        claimNewSavedTrains = (Boolean)config.get("claimNewSavedTrains", (Object)true);
        ...
        claimNewSavedModels = (Boolean)config.get("claimNewSavedModels", (Object)true);
        ...
        hastebin = new Hastebin((JavaPlugin)traincarts, (String)config.get("hastebinServer", (Object)((String)config.get("hastebinServer", (Object)"https://paste.traincarts.net"))));
        ...
        enableSeatThirdPersonView = (Boolean)config.get("enableSeatThirdPersonView", (Object)false);
        config.setHeader("maxDetectorLength", "\nThe maximum length a detector region (between two detectors) can be");
        maxDetectorLength = (Integer)config.get("maxDetectorLength", (Object)2000);
        ...
        optimizeInteraction = (Boolean)config.get("optimizeInteraction", (Object)true);
        ...
        optimizeBlockActivation = (Boolean)config.get("optimizeBlockActivation", (Object)true);
        ...
        instantCreativeDestroy = (Boolean)config.get("instantCreativeDestroy", (Object)true);
        ...
        allowUpsideDownRails = (Boolean)config.get("allowUpsideDownRails", (Object)true);
        ...
        allowSchematicAttachment = (Boolean)config.get("allowSchematicAttachment", (Object)true);
        ...
        itemPickupRadius = (Double)config.get("itemPickupRadius", (Object)2.0);
        ...
        legacySpeedLimiting = (Boolean)config.get("legacySpeedLimiting", (Object)false);
        ...
        allowRailEditing = (Boolean)config.get("allowRailEditing", (Object)true);
        ...
        manualMovementFactor = (Double)config.get("manualMovementFactor", (Object)0.1);
        config.setHeader("currencyFormat", "\nThe currency Ticket signs will display in messages, %value% represents the displayed value");
        currencyFormat = (String)config.get("currencyFormat", (Object)"%value% Dollars");
        ...
        allowNetherTeleport = (Boolean)config.get("allowNetherTeleport", (Object)true);
        ...
        collisionReEnterDelay = (Integer)config.get("collisionReEnterDelay", (Object)collisionReEnterDelay);
        ...
        logMutexConflicts = (Boolean)config.get("logMutexConflicts", (Object)false);
        ...
        logTrainSplitting = (Boolean)config.get("logTrainSplitting", (Object)false);
        ...
        logSyncChunkLoads = (Boolean)config.get("logSyncChunkLoads", (Object)false);
        ...
        cacheVerificationTicks = (Integer)cacheConfig.get("verificationTicks", (Object)0);
        ...
        cacheExpireTicks = (Integer)cacheConfig.get("expireTicks", (Object)20);
        ...
        if (config.contains("allowedBlockBreakTypes")) {
            for (String value : config.getList("allowedBlockBreakTypes", String.class)) {
                Material type = ParseUtil.parseMaterial((String)value, null);
                if (type == null) continue;
                allowedBlockBreakTypes.add(type);
            }
        } else {
            allowedBlockBreakTypes.add(MaterialUtil.getMaterial((String)"LEGACY_CROPS"));
            allowedBlockBreakTypes.add(MaterialUtil.getMaterial((String)"LEGACY_LOG"));
        }
        ...
        activatorEjectEnabled = (Boolean)config.get("activatorEjectEnabled", (Object)true);
        ...
        enableVanillaActionSigns = (Boolean)config.get("enableVanillaActionSigns", (Object)true);
        ...
        for (Object world : config.getList("enabledWorlds", String.class)) {
            enabledWorlds.add((String)world);
        }
        ...
        for (Object world : config.getList("disabledWorlds", String.class)) {
            disabledWorlds.add((String)world);
        }
        List types = config.getList("allowedBlockBreakTypes", String.class);
        types.clear();
        ...
        showTransferAnimations = (Boolean)config.get("showTransferAnimations", (Object)true);
        ...
        craftingRequireWorkbench = (Boolean)config.get("craftingRequireWorkbench", (Object)true);
        ...
        ArrivalSigns.setTimeDurationFormat((String)config.get("triggerTimerDateFormat", (Object)"HH:mm:ss"));
        ...
        if (!config.contains("messageShortcuts")) {
            config.set("messageShortcuts.welcome", (Object)"&eWelcome to &f");
        }
        ...
        if (!config.contains("statementShortcuts")) {
            config.set("statementShortcuts.diamond", (Object)"i@diamond");
        }
        ...
        if (config.contains("parseOldSigns")) {
            parseOldSigns = (Boolean)config.get("parseOldSigns", (Object)false);
        }
        ...
        allowParenthesesFormat = (Boolean)config.get("parseParentheses", (Object)true);
        if (config.contains("onlyPoweredEmptySwitchersDoPathfinding")) {
            if (((Boolean)config.get("onlyPoweredEmptySwitchersDoPathfinding", (Object)false)).booleanValue()) {
                config.set("onlyPoweredSwitchersDoPathFinding", (Object)true);
                config.set("onlyEmptySwitchersDoPathFinding", (Object)true);
            }
        ...
        onlyPoweredSwitchersDoPathFinding = (Boolean)config.get("onlyPoweredSwitchersDoPathFinding", (Object)true);
        ...
        onlyEmptySwitchersDoPathFinding = (Boolean)config.get("onlyEmptySwitchersDoPathFinding", (Object)false);
        ...
        onlyRegisteredSignsHandleRedstone = (Boolean)config.get("onlyRegisteredSignsHandleRedstone", (Object)true);
        config.setHeader("rerouteOnStartup", "\nWhen enabled, re-calculates all path finding routes on plugin startup");
        rerouteOnStartup = (Boolean)config.get("rerouteOnStartup", (Object)false);
        ...
        traincarts.getPathProvider().setMaxProcessingPerTick((Integer)config.get("pathFindingMaxProcessingPerTick", (Object)30));
        ...
        switcherResetCountersOnFirstCart = (Boolean)config.get("switcherResetCountersOnFirstCart", (Object)true);
        ...
        trainsCheckSignFacing = (Boolean)config.get("trainsCheckSignFacing", (Object)true);
        parsers.clear();
        if (!itemshort.contains("fuel")) {
            itemshort.set("fuel", (Object)MaterialUtil.ISFUEL.toString());
        }
        if (!itemshort.contains("heatable")) {
            itemshort.set("heatable", (Object)MaterialUtil.ISHEATABLE.toString());
        }
        if (!itemshort.contains("armor")) {
            itemshort.set("armor", (Object)MaterialUtil.ISARMOR.toString());
        }
        if (!itemshort.contains("sword")) {
            itemshort.set("sword", (Object)MaterialUtil.ISSWORD.toString());
        }
        if (!itemshort.contains("boots")) {
            itemshort.set("boots", (Object)MaterialUtil.ISBOOTS.toString());
        }
        if (!itemshort.contains("leggings")) {
            itemshort.set("leggings", (Object)MaterialUtil.ISLEGGINGS.toString());
        }
        if (!itemshort.contains("chestplate")) {
            itemshort.set("chestplate", (Object)MaterialUtil.ISCHESTPLATE.toString());
        }
        if (!itemshort.contains("helmet")) {
            itemshort.set("helmet", (Object)MaterialUtil.ISHELMET.toString());
        }
        ...
        if (!config.isNode("defaultAnimations")) {
            Iterator<Object> defaults = new Animation[]{new Animation("rotate", "t=0.25 yaw=0.0", "t=0.25 yaw=90.0", "t=0.25 yaw=180.0", "t=0.25 yaw=270.0", "t=0.0 yaw=360.0"), new Animation("roll", "t=0.25 roll=0.0", "t=0.25 roll=90.0", "t=0.25 roll=180.0", "t=0.25 roll=270.0", "t=0.0 roll=360.0"), new Animation("pitch", "t=0.25 pitch=0.0", "t=0.25 pitch=90.0", "t=0.25 pitch=180.0", "t=0.25 pitch=270.0", "t=0.0 pitch=360.0")};
            ConfigurationNode defaultAnimationsNode = config.getNode("defaultAnimations");
            for (Iterator<Object> anim : defaults) {
                ((Animation)((Object)anim)).saveToParentConfig(defaultAnimationsNode);
            }
        }
        ...
        for (Map.Entry entry : itemshort.getValues(String.class).entrySet()) {
            TCConfig.putParsers((String)entry.getKey(), Util.getParsers((String)entry.getValue()));
        }
        ...
        allowExternalTicketImagePaths = (Boolean)config.get("allowExternalTicketImagePaths", (Object)false);
        if (config.contains("playSoundAtStation")) {
            config.set("sounds.hissWhenStopAtStation", config.get("playSoundAtStation", (Object)true));
        ...
        playHissWhenStopAtStation = (Boolean)soundsConfig.get("hissWhenStopAtStation", (Object)true);
        ...
        playHissWhenDestroyedBySign = (Boolean)soundsConfig.get("hissWhenDestroyedBySign", (Object)true);
        ...
        playHissWhenCartRemoved = (Boolean)soundsConfig.get("playHissWhenCartRemoved", (Object)true);
        soundsConfig.setHeader("hissWhenLinked", "Enable/disable hiss sound played when two carts connect together");
        playHissWhenLinked = (Boolean)soundsConfig.get("hissWhenLinked", (Object)true);
        ...
        upsideDownSupportedByAll = (Boolean)config.get("upsideDownSupportedByAll", (Object)true);
        ...
        if (!config.contains("attachmentTransformParallelism")) {
            config.set("attachmentTransformParallelism", (Object)"auto");
            attachmentTransformParallelism = -1;
        } else {
            attachmentTransformParallelism = "auto".equals(config.get("attachmentTransformParallelism")) ? -1 : (Integer)config.get("attachmentTransformParallelism", (Object)-1);
        }
        ...
        unloadRunawayTrainDistance = (Double)config.get("unloadRunawayTrainDistance", (Object)160.0);
        ...
        maxCommandSelectorValues = (Integer)config.get("maxCommandSelectorValues", (Object)128);
        ...
        int max = (Integer)config.get("maxConcurrentEffectLoops", (Object)20);
        if (max < 0) {
        ...
        spawnSignCooldown = (Double)config.get("spawnSignCooldown", (Object)-1.0);
        ...
        maxCartsPerWorld = (Integer)cartLimits.get("maxCartsPerWorld", (Object)-1);
        cartLimits.setHeader("countUnloaded", "\nWhether to include unloaded trains/carts in the maxCartsPerWorld limit");
        maxCartsPerWorldCountUnloaded = (Boolean)cartLimits.get("countUnloaded", (Object)false);
        ...
        maxCartsPerTrain = (Integer)cartLimits.get("maxCartsPerTrain", (Object)-1);
    }

    public static void putParsers(String key, ItemParser[] parsersArr) {
        if (LogicUtil.nullOrEmpty((Object[])parsersArr)) {
    ...
    static {
        ...
        railTrackerDebugEnabled = false;
        wheelTrackerDebugEnabled = false;
        ...
        onlyRegisteredSignsHandleRedstone = true;
        enableSneakingInAttachmentEditor = false;
        playHissWhenStopAtStation = true;
        playHissWhenDestroyedBySign = true;
        playHissWhenLinked = true;
        ...
        launchFunctionType = "bezier";
        allowParenthesesFormat = true;
        upsideDownSupportedByAll = false;
        ...
        itemPickupRadius = 2.0;
        maxCartsPerWorld = -1;
        maxCartsPerTrain = -1;
        maxCartsPerWorldCountUnloaded = false;
        modelSearchCompactFolders = true;
        allowedBlockBreakTypes = new HashSet<Material>();
        enabledWorlds = new ConfiguredWorldSet();
        disabledWorlds = new ConfiguredWorldSet();
        enableVanillaActionSigns = true;
        parsers = new HashMap<String, ItemParser[]>();
        resourcePack = MapResourcePack.SERVER;
        defaultAnimations = new HashMap<String, Animation>();
        hastebin = null;
    }
}
