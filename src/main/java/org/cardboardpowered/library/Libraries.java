...
public class Libraries {
	...
	public static List<Library> getLibraries() {
        ...
        Library paperApi = Library.of("io.papermc.paper", "paper-api", "26.2.build.56-alpha")
        ...
        List<Library> libraries = List.of(
        	...
        	// Adventure
        	Library.of("net.kyori", "adventure-api", adventureVersion),
        	Library.of("net.kyori", "adventure-key", adventureVersion) ,
        	Library.of("net.kyori", "adventure-text-serializer-gson", adventureVersion) ,
        	Library.of("net.kyori", "adventure-text-serializer-json", adventureVersion) ,
        	Library.of("net.kyori", "adventure-text-serializer-commons", adventureVersion) ,
        	Library.of("net.kyori", "adventure-text-serializer-legacy", adventureVersion) ,
        	Library.of("net.kyori", "adventure-text-serializer-plain", adventureVersion) ,
        	Library.of("net.kyori", "adventure-text-minimessage", adventureVersion) ,
        	Library.of("net.kyori", "adventure-text-logger-slf4j", adventureVersion) ,
